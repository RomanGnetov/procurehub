...
public class LotRecord extends UpdatableRecordImpl<LotRecord> implements Record8<Integer, String, String, BigDecimal, String, String, String, LocalDateTime> {
     ...
     */
    public LotRecord(Integer id, String lotName, String customerCode, BigDecimal price, String currencyCode, String ndsRate, String placeDelivery, LocalDateTime dateDelivery) {
        super(Lot.LOT);
     ...
     * Create a detached, initialised LotRecord
     */
    public LotRecord(com.example.jooq.tables.pojos.Lot value) {
        super(Lot.LOT);
